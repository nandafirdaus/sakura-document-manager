	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">Daftar RPTKA</div>
				<div class="panel-body">
					...
					<div class="form-group">
						<a class="btn btn-primary btn-sm" href="{{ url('/rptka/create') }}" role="button">Tambah RPTKA</a>
					</div>
							...
							<tbody>
								@foreach ($rptkas->all() as $rptka)
									<tr>
										...
										<td>
											<a class="btn btn-success" href="{{ url('/rptka/' . $rptka->id . '/view') }}" role="button">Lihat</a>
											<a class="btn btn-primary" href="{{ url('/rptka/' . $rptka->id . '/edit') }}" role="button">Edit</a>
											<a class="btn btn-warning" href="{{ url('/rptka/' . $rptka->id . '/delete') }}" role="button" Onclick="javascript:return confirm('Yakin ingin menghapus data ini?');">Hapus</a>
										</td>
									</td>
								@endforeach
							</tbody>
