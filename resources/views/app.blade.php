...
<head>
	...
	<script type="text/javascript" src="{{ URL::asset('js/jquery.tablesorter.pager.js') }}"></script>
	<script type="text/javascript" src="{{ URL::asset('js/jquery.tablesorter.widgets.js') }}"></script>
