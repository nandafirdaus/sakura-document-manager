	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">Daftar KITAS Expired</div>
...
<!--					<div class="form-group">
						<a class="btn btn-primary btn-sm" href="{{ url('/report/kitas') }}" role="button">Download Laporan</a>
					</div>-->
							...
							<tbody>
								@foreach ($kitases->all() as $kitas)
									<tr>
										...
										<td>
											<a class="btn btn-success" href="{{ url('/kitas/' . $kitas->id . '/view?prev=expired') }}" role="button">Lihat</a>
											<a class="btn btn-primary" href="{{ url('/kitas/' . $kitas->id . '/edit?prev=expired') }}" role="button">Edit</a>
											<a class="btn btn-warning" href="{{ url('/kitas/' . $kitas->id . '/delete?prev=expired') }}" role="button" Onclick="javascript:return confirm('Yakin ingin menghapus data ini?');">Hapus</a>
										</td>
									</td>
								@endforeach
							</tbody>
