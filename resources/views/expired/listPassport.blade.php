	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">Daftar Passport Expired</div>
...
<!--					<div class="form-group">
						<a class="btn btn-primary btn-sm" href="{{ url('/report/passport') }}" role="button">Download Laporan</a>
					</div>-->
							...
							<tbody>
								@foreach ($employees->all() as $employee)
									<tr>
										...
										<td>{{$employee->passport_expired}}</td>
										<td>
											<a class="btn btn-success" href="{{ url('/employee/' . $employee->id . '/view?prev=expired') }}" role="button">Lihat</a>
											<a class="btn btn-primary" href="{{ url('/employee/' . $employee->id . '/edit?prev=expired') }}" role="button">Edit</a>
											<a class="btn btn-warning" href="{{ url('/employee/' . $employee->id . '/delete?prev=expired') }}" role="button" Onclick="javascript:return confirm('Yakin ingin menghapus data ini?');">Hapus</a>
										</td>
									</td>
								@endforeach
							</tbody>
